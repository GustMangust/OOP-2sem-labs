...
namespace GoodFood.ViewModel {
  class UserBookingsViewModel : ViewModelBase {
    ...
    private void UpdateBookings() {
      ...
      List<Booking> bookings = new List<Booking>(UnitOfWork.GetBookings());
      ...
      foreach(Booking booking in bookings) {
        if(booking.User_ID == MainViewModel.User.User_ID) {
          ...
          string restName = UnitOfWork.GetRestaurants().FirstOrDefault(x => x.Rest_ID == booking.Rest_ID).Name;
    ...
    private void DeleteBooking() {
      int restId = UnitOfWork.GetRestaurants().FirstOrDefault(x => x.Name == SelectedBooking.RestaurantName).Rest_ID;
      ...
      UnitOfWork.DeleteBooking(booking);
      UpdateBookings();
    }
